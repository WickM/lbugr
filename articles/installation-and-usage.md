...
This vignette provides a guide to `lbugr` and performing basic
...
First, load the `lbugr` package and create a connection to a Ladybug
...
Ladybug supports a rich set of data types. When creating a schema, you
need to map your R data types to the corresponding Ladybug
`LogicalTypeID`.
...
You can load data into your Ladybug tables from R data frames or
external files like CSV.
