...
First, ensure you have the `lbugr` package installed. The package includes the Ladybug database engine bundled via Rust, so no external dependencies are required.
