...
ggraph::ggraph(tidygraph_graph, layout = "kk") +
  ggraph::geom_edge_link(color = "#9ca3af", arrow = grid::arrow(angle = 30, length = grid::unit(3, "mm")), arrow.fill = "#9ca3af", end_cap = grid::arrow(angle = 30, length = grid::unit(3, "mm"))) +
